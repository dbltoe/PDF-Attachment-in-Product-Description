 ...
 * @version $Id: update_product.php for PDF Attachment Mod v2.2.0 2021-04-30 117:49:16Z dbltoe $
 */
...
if (isset($_POST['edit']) && $_POST['edit'] == 'edit') {
  $action = 'new_product';
} elseif ((isset($_POST['products_model']) ? $_POST['products_model'] : '') . (isset($_POST['products_url']) ? implode('', $_POST['products_url']) : '') . (isset($_POST['products_name']) ? implode('', $_POST['products_name']) : '') . 
(isset($_POST['pdf_attachment_name']) ? implode('', $_POST['pdf_attachment_name']) : '') . 
(isset($_POST['products_description']) ? implode('', $_POST['products_description']) : '') != '') {
