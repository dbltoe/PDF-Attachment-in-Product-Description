 ...
 * @version $Id: preview_info.php for PDF Attachment Mod v2.2.0 2021-04-30 14:49:16Z dbltoe $
 */
...
if (zen_not_null($_POST)) {
  ...
  $product = $db->Execute("SELECT p.*,
                                  pd.language_id, pd.products_name, pd.pdf_attachment_name, pd.products_description, pd.products_url
