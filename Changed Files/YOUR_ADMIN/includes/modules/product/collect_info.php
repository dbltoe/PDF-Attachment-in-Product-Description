 ...
 * @version $Id: collect_info.php for PDF Attachment Mod v2.2.0 2021-04-30 07:53:50Z webchills $
 */
...
if (isset($_GET['pID']) && empty($_POST)) {
  $product = $db->Execute("SELECT pd.products_name, pd.products_description, pd.products_url, pd.pdf_attachment_name,
                                  p.*, 
