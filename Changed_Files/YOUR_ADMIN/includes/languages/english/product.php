...
// bof pdf attachment
define('TEXT_PDF_ATTACHMENT_NAME', 'Name for the PDF Attachment: ');
define('TEXT_PRODUCTS_PDF_ATTACHMENT', 'File for the PDF Attachment: ');
define('TEXT_PDF_ATTACHMENT_NONEXISTENT', 'Currently no PDF is Added');
define('TEXT_PRODUCTS_PDF_ATTACHMENT', 'PDF Attachment for the Product: ');
define('TEXT_PRODUCTS_PDF_ATTACHMENT_DIR', 'Upload to Directory: ');
define('TEXT_PDF_ATTACHMENT_CURRENT', 'PDF File: ');
define('TEXT_PDF_ATTACHMENT_DELETE', 'Delete PDF?<br/>Removes the PDF from the product. The PDF will NOT be deleted from server.');
define('TEXT_PDF_ATTACHMENT_OVERWRITE', 'Overwrite existing PDF on the server? Use "No" if you enter the filename manually');
define('TEXT_PRODUCTS_PDF_ATTACHMENT_MANUAL', 'Or choose an existing PDF from the server. Filename: ');
// eof pdf attachment
