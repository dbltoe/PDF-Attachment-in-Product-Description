 ...
 * @version $Id: copy_product_confirm.php for PDF Attachment Mod v2.2.0 2021-04-30 18:11:16Z dbltoe $
 */
...
if (isset($_POST['products_id'], $_POST['categories_id'])) {
    ...
    if ($_POST['copy_as'] == 'link') {
        ...
        $descriptions = $db->Execute("SELECT language_id, products_name, pdf_attachment_name, products_description, products_url
